...
export const financial = () => {
    ...
    {store.financials.map((each, i) => {
        return (
            <div className="financial d-flex row">
                <ul className="financial-col">
                    ...
                    <li className="account-value-item"></li>
                    <li className="account-value-item sub-header"></li>
                    ...
                    <li className="account-value-item"></li>
                    <li className="account-value-item subheader"></li>
                ...
                <ul className="financial-col">
                    <li className="margin-item statement-header"></li>
                    <li className="margin-item statement-header"></li>
                    <li className="margin-item"></li>
                    <li className="margin-item sub-header">%</li>
                    <li className="margin-item"></li>
                    <li className="margin-item"></li>
                    <li className="margin-item sub-account"></li>
                    <li className="margin-item sub-account"></li>
                    <li className="margin-item sub-account"></li>
                    <li className="margin-item sub-total"></li>
                    <li className="margin-item total"></li>
                    <li className="margin-item"></li>
                    <li className="margin-item sub-account"></li>
                    <li className="margin-item sub-account"></li>
                    <li className="margin-item sub-account"></li>
                    ...
                    <li className="margin-item"></li>
                    <li className="margin-item subheader"></li>
                    <li className="margin-item"></li>
                    <li className="margin-item"></li>
                    <li className="margin-item"></li>
                    <li className="margin-item sub-total"></li>
